...
public class Main {
	public static void main(String[] args) {
		...
		*/
		...
		ArrayList<Long> privateKeyList = key.getPrivateKeyWithPublicKey(publicKeyList);
		
		ArrayList<Long> decryptedList = Algorithm.getDecryptionList(testList, privateKeyList);
		System.out.println("Decrypted list" + decryptedList);
		ArrayList<Long> encryptedList = Algorithm.getEncryptionList(decryptedList, publicKeyList);
		System.out.println("Re-encrypted list" + encryptedList);
		...
		*/
		...
		/*
		 ...
		 ArrayList<Long> privateKeyList = key.getPrivateKeyWithPublicKey(publicKeyList2);
		 
		 ArrayList<Long> decryptedList2 = Algorithm.getDecryptionList(testList2,privateKeyList);
		 System.out.println("Decrypted list" + decryptedList2);
		 ArrayList<Long> encryptedList2 = Algorithm.getEncryptionList(decryptedList2,
		 publicKeyList2); System.out.println("Re-encrypted list" + encryptedList2);
		 /*
		...
		/* Transformer le message lettre en chiffre base 40*/
		...
		ArrayList<Long> messageDecompositionConvertedCrypted = Algorithm.getEncryptionList(messageDecompositionConverted, publicKey3) ;
		System.out.println("Message crypté par bloc : " + messageDecompositionConvertedCrypted);
		
		/* Décrypter le message */
		
		ArrayList<Long> messageDecompositionConvertedDecrypted = Algorithm.getDecryptionList(messageDecompositionConvertedCrypted, privateKey3) ;
		System.out.println("Message par bloc converti décrypté : " + messageDecompositionConvertedDecrypted);
		
		//je fais une modular exponentiation sur la liste
		
		//decomposer en base 40
		
		/* Convertir en string */ 
		
		
		System.out.println("test : " + Algorithm.getConversionFromListToString(messageDecompositionConvertedDecrypted, n)) ;
	
		
		System.out.println("Test EN : " + Algorithm.modularExponentiation(173, 3, 187));
		System.out.println("Test VO : " + Algorithm.modularExponentiation(854, 3, 187));
		System.out.println("Test YE : " + Algorithm.modularExponentiation(964, 3, 187));
		System.out.println("Test RA : " + Algorithm.modularExponentiation(684, 3, 187));
		
		System.out.println("Test EN suite : " + Algorithm.modularExponentiation(61, 107,187));
		System.out.println("Test EN suite suite : " + Algorithm.getDecompositionBase40(173)) ;
		
		System.out.println("Test VO suite : " + Algorithm.modularExponentiation(13, 107,187));
		System.out.println("Test VO suite suite : " + Algorithm.getDecompositionBase40(106)) ; //erreur on obtient C_
